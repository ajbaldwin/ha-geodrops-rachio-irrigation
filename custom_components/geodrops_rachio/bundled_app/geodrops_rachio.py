...
STATE_DIR = "/config/pyscript/geodrops_rachio_state"
...
PERSISTED = ("geodrops_rachio_last_nightly", "geodrops_rachio_calibration",
             "geodrops_rachio_targets", "geodrops_rachio_preview")
...
def set_run_active(on):
    ...
    service.call("switch", "turn_on" if on else "turn_off",
...
def _publish_targets(cfg):
    ...
    _publish_record("geodrops_rachio_targets", len(floors), {
...
def _preview_body(cfg, stamp):
    ...
    if _is_standby():
        ...
        _publish_record(
            "geodrops_rachio_preview", "standby",
...
@state_trigger("button.geodrops_rachio_stop")
